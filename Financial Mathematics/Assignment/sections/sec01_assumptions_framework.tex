...
\begin{tikzpicture}[
    ...
    banner/.style = {
        ...
        text width=13.0cm, minimum height=0.9cm, rounded corners=1.2mm,
    ...
    decision/.style = {
        ...
        text width=13.0cm, minimum height=0.75cm, rounded corners=1.2mm,
    ...
    \node[banner] (inputs) {\textbf{Corporate Dataset Inputs (Ten Sampled FMCG Firms)}\\[1.5pt]
        \scriptsize Reported Balance Sheet $\bm{\cdot}$ FY26 EPS $\bm{\cdot}$ 5-Yr PAT CAGR $\bm{\cdot}$ $\Ke = 14.0\%$ $\bm{\cdot}$ Growth Cap $g \le 12.0\%$};
    ...
    \node[card, below=0.8cm of inputs] (card2) {
        ...
        \scriptsize Cost-of-Equity Hurdle:\\[1pt]
