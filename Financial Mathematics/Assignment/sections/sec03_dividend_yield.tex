...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l r r r r c c}
\toprule
\textbf{Company} & \textbf{FY26 EPS} & \textbf{Proxy DPS (70\%)} & \textbf{Market Price} & \textbf{Current Yield} & \textbf{Hurdle ($\Ke$)} & \textbf{Yield Verdict} \\
 & (\inr) & (\inr) & (\inr) & (\%) & (\%) & \\
\midrule
