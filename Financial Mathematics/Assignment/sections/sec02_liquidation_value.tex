...
\toprule
\textbf{Company} & \textbf{Total Assets} & \textbf{Goodwill} & \textbf{Liabilities} & \textbf{Net Realizable} & \textbf{Shares} & \textbf{LV / Share} & \textbf{Market Price} \\
 & (\inr Cr) & (\inr Cr) & (\inr Cr) & (\inr Cr) & (Cr) & (\inr) & (\inr) \\
\midrule
