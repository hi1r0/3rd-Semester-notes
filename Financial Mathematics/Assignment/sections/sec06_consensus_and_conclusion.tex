...
\toprule
\textbf{Company} & \shortstack[c]{\textbf{Liquidation}\\\textbf{Value Floor}} & \shortstack[c]{\textbf{Dividend Yield}\\\scriptsize($\Ke = 14\%$ Hurdle)} & \shortstack[c]{\textbf{Gordon DDM}\\\scriptsize(Intrinsic Value)} & \shortstack[c]{\textbf{Consensus (2/3)}\\\textbf{Classification}} \\
\midrule
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l l p{5.5cm}}
\toprule
\textbf{Valuation Metric} & \textbf{Mathematical Formulation} & \textbf{Operational Financial Purpose} \\
\midrule
\textbf{Liquidation Value} & $\LV = \dfrac{\text{Total Assets} - \text{Goodwill} - \text{Liab.}}{\text{Shares Outstanding}}$ & Demarcates the hard tangible breakdown floor. \\
